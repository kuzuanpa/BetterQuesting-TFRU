...
public class NetChapterEdit {
    ...
    private static void onServer(Tuple2<NBTTagCompound, EntityPlayerMP> message) {
        ...
        switch (action) {
            case ACTION_EDIT :
                editChapters(payload.getTagList(TAG_QUEST_LINES, Constants.NBT.TAG_COMPOUND));
                break;
            case ACTION_DELETE  :
                deleteChapters(
            ...
            case ACTION_REORDER  :
                ...
                break;
            case ACTION_CREATE :
                createChapters(payload.getTagList(TAG_QUEST_LINES, Constants.NBT.TAG_COMPOUND));
                break;
            default:
