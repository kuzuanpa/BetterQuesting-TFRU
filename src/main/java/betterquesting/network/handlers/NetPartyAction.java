...
public class NetPartyAction {
    ...
    private static void onServer(Tuple2<NBTTagCompound, EntityPlayerMP> message) {
        ...
        int partyID = payload.hasKey(TAG_PARTY_ID, Constants.NBT.TAG_ANY_NUMERIC) ? payload.getInteger(TAG_PARTY_ID) : -1;
        ...
        switch (action) {
            case ACTION_CREATE :
                createParty(sender, payload.getString(TAG_PARTY_NAME));
                break;
            case ACTION_DELETE :
            ...
            case ACTION_ACCEPT_INVITE :
                ...
                break;
            case ACTION_KICK :
                kickUser(partyID, sender, party, payload.getString(TAG_INVITE_USERNAME), senderPermission);
                break;
            default :
                BetterQuesting.logger.log(Level.ERROR, "Invalid party action '{}'. Full payload:\n{}", action, payload);
        }
    }
