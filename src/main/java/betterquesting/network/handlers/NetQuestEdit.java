...
public class NetQuestEdit {
    ...
    private static void onServer(Tuple2<NBTTagCompound, EntityPlayerMP> message) {
        ...
        switch (action) {
            case ACTION_EDIT :
                editQuests(payload.getTagList(TAG_QUEST_LIST, Constants.NBT.TAG_COMPOUND));
                break;
            case ACTION_DELETE :
                deleteQuests(NBTConverter.UuidValueType.QUEST.readIds(payload, TAG_QUEST_IDS));
            ...
            case ACTION_COMPLETE :
                ...
                break;
            case ACTION_CREATE :
                createQuests(payload.getTagList(TAG_QUEST_LIST, Constants.NBT.TAG_COMPOUND));
                break;
            default :
                BetterQuesting.logger.log(Level.ERROR, "Invalid quest edit action '{}'. Full payload:\n{}", action, payload);
                break;
        }
    }
