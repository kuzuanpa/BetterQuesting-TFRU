...
public class QuestNotification {
    ...
    private static final boolean HAS_TITLE_API= false;
    static {
        boolean found;
        try {
    ...
    public static void ScheduleNotice(String mainTxt, String subTxt, ItemStack icon, String sound, List<String> unlockedQuests) {
        ScheduleNotice(mainTxt, subTxt, icon, sound, unlockedQuests, new NoticeConfig());
    }
    ...
    public static void previewNotice(String mainTxt, String subTxt, ItemStack icon, String sound, List<String> unlockedQuests, NoticeConfig config) {
        if ("off".equals(effStyle(config))) return;
        notices.add(new QuestNotice(mainTxt, subTxt, icon, sound, unlockedQuests, config, false));
    }
    ...
    public static class QuestNotice {
        ...
        public QuestNotice(String mainTxt, String subTxt, ItemStack icon, String sound, List<String> unlockedQuests ) {
            this(mainTxt, subTxt, icon, sound, unlockedQuests, new NoticeConfig(), false);
        }

        public QuestNotice(String mainTxt, String subTxt, ItemStack icon, String sound, List<String> unlockedQuests , NoticeConfig config,
            boolean showHint) {
